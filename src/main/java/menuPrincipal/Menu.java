...
public class Menu
{
	...
	private static MathematicalStatsCalculator msc
            = new MathematicalStatsCalculator();
            ...
            ClassNotFoundException
	{
		...
		do
			...
			System.out.println("\n \t Menu"
					+ "\n 1. Voir les données des employés"
                    + " d'une entreprise."
					+ "\n 2. Voir les données des employés "
                    + "pour un projet."
					+ "\n 3. Voir les informations sur le "
                    + "salaire"
					+ "\n 4. Comparer les entreprises selon"
                    + " des caractères précis."
					+ " \n 5. Obtenir des statistiques avancés"
                    + " sur votre entreprise ou projet\n");
			System.out.print("Votre choix: ");
			i=scan.nextInt();
			switch(i)
			{
			case 1: 
				System.out.println("Sélectionnez l'entreprise "
                        + "souhaitée (entrez l'id):\n");
				afficherLignes("Industrie");
				userChoice=scan.nextInt();
				//On vérifie que l'ID est bien présent dans la table
				if(verif.verifValiditeID(userChoice,
                        "industrie"))
				{
					//On vérifie que des données sont bien présentes
                    // dans la table
					if(verif.verifDataInDB(userChoice,
                            "industrie"))
					{
						System.out.println("\n Moyenne d'heure"
                                + " des employés pour l'entreprise :"
								+ msc.getMoyenneHeureEmployeEntreprise(
								        userChoice));
						System.out.println("\n Somme d'heure des "
                                + "employés pour l'entreprise : "
								+ msc.getSommeHeureEmployeEntreprise(
								        userChoice));
						System.out.println("\n Variance d'heure des"
                                + " employés pour l'entreprise :"
								+ msc.getVarianceHeureEmployeEntreprise(
								        userChoice));
						System.out.println("\n Ecart-Type d'heure des "
                                + "employés pour l'entreprise : "
								+ msc.getEcartTypeHeureEmployeEntreprise(
								        userChoice));
					}}
				break;

			case 2: 
				System.out.println("Séléctionnez le projet souhaité "
                        + "(entrez l'id) ");
				...
				if(verif.verifValiditeID(userChoice, "projet"))
				{
					...
					{
						System.out.println(verif.verifDataInDB(userChoice,
                                "projet"));
						System.out.println("\n Moyenne d'heure des employés "
                                + "pour le projet :"
								+ msc.getMoyenneHeureEmployeProjet(
								        userChoice));
						System.out.println("\n Somme d'heure des "
                                + "employés pour le projet : "
								+ msc.getSommeHeureEmployeProjet(
								        userChoice));
						System.out.println("\n Variance d'heure des "
                                + "employés pour le projet :"
								+ msc.getVarianceHeureEmployeProjet(
								        userChoice));
						System.out.println("\n Ecart-Type d'heure des"
                                + " employés pour le projet : "
								+ msc.getEcartTypeHeureEmployeProjet(
								        userChoice));
					}
				}
			...
			case 4 :
				...
				do
					...
					ArrayList<Integer> listOfId = dr.listeIdTable(
					        "industrie");
					...
					case 1 :
						...
						case 1:
							System.out.println("Comparaison des salaires"
                                    + " selon le statut :");
							...
							for(int j = 0; j < listOfId.size(); j++)
							{
								System.out.println("L'entreprise : "
                                        + dr.nameInTable(listOfId.get(j),
                                        "industrie")
								+" offre comme salaire moyen a ses stagiaires : "
                                        + df.format(sal.salaire_cond(
                                                "employe",
                                        "statut",
												"stagiaire",
						...
						case 2:
							System.out.println("Comparaison des "
                                    + "salaires selon le statut :");
							listOfId = dr.listeIdTable("industrie");
							for(int j = 0; j < listOfId.size(); j++)
							{
								System.out.println("L'entreprise : "
					...
					case 2 :
						System.out.println("Sélectionnez le genre "
                                + "dont vous souhaitez comparer les "
			...
			case 5 :
				System.out.println("Voulez-vous des statistiques "
                        + "avancées sur votre entreprise ou votre projet ?"
						+ "\n1. Entreprise."
						+ "\n2. Projet.");
				switch(new Scanner(System.in).nextInt())
				{
				...
				case 1: 
					...
					int userChoice3;
					if(verif.verifValiditeID(userChoice3
